...
| `data/DATASET_AUDIT.md` | generated dataset facts (resolves the TO VERIFY items) | regenerated by `python -m pso_rf audit` |
| `scripts/` | one-time utilities (download) | not imported by the package |
